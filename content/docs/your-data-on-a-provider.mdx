...
When this site says "your data lives on your provider, not in Sifa ID's database", it's a literal description of how the system works. This page makes it concrete.
...
Most Sifa records don't have blobs. Profile photos are the obvious exception. The [Standard.site cards](/docs/standard-site-cards) page covers a working example of fetching and reusing a blob from your account.

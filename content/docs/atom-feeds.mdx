...
- **Bridge to non-Atmosphere apps.** Tools that don't yet understand AT Protocol (link aggregators, automation services, custom dashboards) can still ingest your activity through plain XML.

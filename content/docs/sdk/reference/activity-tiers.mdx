...
The activity taxonomy sorts every AT Protocol record type that Sifa knows into one of three **tiers**. The tier decides whether a record shows on a profile, and how. This page renders the live data from `@singi-labs/sifa-sdk@<SdkVersion inline />`.

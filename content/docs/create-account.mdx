...
Other Atmosphere providers (Northsky, [Blacksky](https://blacksky.community), Skylight, and others) work the same. Pick whichever fits, then sign in with the resulting username.

You can move your account between PDSes later without losing any of your Sifa data. Portability like that is the reason Sifa builds on an open protocol instead of its own database.
...
When you sign in to Sifa, Sifa reads from and writes to your PDS via AT Protocol APIs. Sifa does not have its own copy of your account. If you switch PDSes, delete records, or move to a different Atmosphere app, your data is yours and travels with you.

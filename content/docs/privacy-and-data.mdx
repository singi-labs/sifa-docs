...
Do you need a copy of Sifa-side metadata, such as session logs or analytics, for compliance? [Open an issue](https://github.com/singi-labs/sifa-workspace/issues) or email the team. EU users have GDPR rights of access and erasure. We honour both.

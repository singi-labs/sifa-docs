...
No need to request it. It's already on your provider, where you have direct access. See [Your data on a provider](/docs/your-data-on-a-provider) for how to inspect or export it via pdsls.dev or the AT Protocol API.

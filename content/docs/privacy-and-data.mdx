...
Sifa's own database holds things that aren't [AT Protocol](https://atproto.com) records:
...
- Endorsements other people gave you are owned by _their_ provider. They don't disappear from those accounts when you leave Sifa.
...
No need to request it. It's already on your provider, where you have direct access. See [Your data on a provider](/docs/your-data-on-a-provider) for how to inspect or export it via [pdsls.dev](https://pdsls.dev) or the AT Protocol API.

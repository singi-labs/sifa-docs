...
The setup happens at the **[AT Protocol](https://atproto.com) level**, on your provider. Sifa ID does not run a whitelabel username service. What Sifa gives you is the profile that uses whichever username you have configured upstream.

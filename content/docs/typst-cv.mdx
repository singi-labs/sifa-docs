...
description: Export your Sifa profile as a JSON Resume file, then compile it into a typeset PDF CV with a Typst template.
---
...
1. Open [typst.app](https://typst.app/) and create an empty project.
2. Upload `sifa-cv.typ` and `resume.json` into the project.
3. Open `sifa-cv.typ`. The preview shows your CV.
4. Select **Export PDF**.

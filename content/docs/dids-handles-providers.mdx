...
The three pieces work together. You don't usually think about them directly because apps like Sifa ID hide them. Knowing what each does makes the rest of the network easier to follow.
...
You rarely see your DID unless you ask for it. Sifa shows it in profile settings and on the developer-facing parts of [AT Protocol](https://atproto.com). You don't memorise it. You copy-paste it if something needs it.

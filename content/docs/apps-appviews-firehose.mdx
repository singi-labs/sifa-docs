...
Neither view is the "real" one. Both are honest renderings of the same records, filtered for different purposes. Want to see your full firehose activity? An app called [PDS Reader](https://pdsls.dev) shows everything on your account.

...
Kuba Suder's [Introduction to AT Protocol](https://mackuba.eu/2025/08/20/introduction-to-atproto/) is the canonical long read. It tours every layer, and it covers labellers, feed generators, and the PLC directory.

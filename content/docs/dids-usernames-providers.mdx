...
It's your **account's true name**. The username you use day to day is a friendly alias on top. The DID is what Sifa stores when it writes records about you, what other Atmosphere apps refer to you by, and what stays the same when you move providers, change your username, or repoint your custom domain.
...
You can change providers without losing anything. Migrate from Bluesky to Eurosky and your followers, posts, profile data, and Sifa records come with you. The DID stays the same. The username may need re-pointing if you used a provider subdomain.

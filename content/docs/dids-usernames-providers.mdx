...
You rarely see your DID unless you ask for it. Sifa shows it under **Settings → Account**, and on the developer-facing parts of [AT Protocol](https://atproto.com). You do not memorise it. You copy it and paste it when something needs it.

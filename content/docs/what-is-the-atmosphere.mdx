...
On the Atmosphere, your followers are stored on your account. They follow your **DID** (a permanent identifier), not your username, not the app you're using. Move from Sifa to a different professional-network app tomorrow and the same followers are there, ready to see your work. You can't lose them unless you delete them yourself.

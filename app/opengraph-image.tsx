...
export default function DocsOgImage() {
  return new ImageResponse(
    ...
    >
      {/* "DOCS" pill in the corner so readers can tell this is the docs property, not the app */}
      <div
        style={{
          position: 'absolute',
          top: 40,
      ...
      {/* Sifa logo mark (identical paths to sifa-web OG, primary fill swapped for sifa-sdk token) */}
      ...
      >
        Documentation for Sifa on the AT Protocol
      </div>
    </div>,
    { ...size }
  )
